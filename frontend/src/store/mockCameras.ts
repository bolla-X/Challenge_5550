...
export const MOCK_CAMERAS: CameraMock[] = [
  {
    ...
    status: "ok",
    fps: 12,
    features: { helmet: true, vest: true, gloves: false, glasses: false, pose: false, falls: false, posture: false, risk_area: false },
    alerts: [],
    risk_score: 12,
  ...
  },
  {
    ...
    status: "ok",
    fps: 10,
    features: { helmet: true, vest: true, gloves: true, glasses: true, pose: true, falls: true, posture: true, risk_area: true },
    alerts: [
  ...
  },
  {
    ...
    status: "offline",
    fps: 0,
    features: { helmet: false, vest: false, gloves: false, glasses: false, pose: true, falls: false, posture: false, risk_area: false },
  ...
  },
  {
    ...
    status: "ok",
    fps: 12,
    features: { helmet: false, vest: false, gloves: false, glasses: false, pose: true, falls: true, posture: false, risk_area: false },
    alerts: [],
    risk_score: 5,
    driving_feature: null,
